...
const dep = { network, chainId, registry: byName.FieldAttestationRegistry, usdt: byName.MockUSDT, agentWallet: byName.AgentWallet, deployedAt: new Date().toISOString(), deployBlock };
